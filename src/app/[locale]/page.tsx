        ...
        <aside className="hidden md:flex flex-col justify-center flex-1 max-w-md space-y-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2">
                <div>
                  ...
                  <p className="text-gray-500">{tApp('tagline')}</p>
                </div>
                <LanguageSwitcher />
              </div>
            </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="desktop-feature-card">
              ...
              <p className="text-sm font-medium text-gray-900">{tHome('features.autoLocationTitle')}</p>
              <p className="text-xs text-gray-500">{tHome('features.autoLocationSubtitle')}</p>
            </div>
            <div className="desktop-feature-card">
              <Cloud className="h-5 w-5 text-sky-500 mb-2" />
              <p className="text-sm font-medium text-gray-900">{tHome('features.weatherTitle')}</p>
              <p className="text-xs text-gray-500">{tHome('features.weatherSubtitle')}</p>
            </div>
            <div className="desktop-feature-card">
              <Clock className="h-5 w-5 text-indigo-500 mb-2" />
              <p className="text-sm font-medium text-gray-900">{tHome('features.trafficTitle')}</p>
              <p className="text-xs text-gray-500">{tHome('features.trafficSubtitle')}</p>
            </div>
            <div className="desktop-feature-card">
              <ShieldCheck className="h-5 w-5 text-green-500 mb-2" />
              <p className="text-sm font-medium text-gray-900">{tHome('features.riskTitle')}</p>
          ...
          <header className="app-header sticky top-0 z-50 border-b border-gray-200/50 pt-safe md:hidden">
            <div className="flex items-center justify-between gap-2 px-4 py-3">
              <div className="flex items-center gap-2">
                ...
                <span className="font-bold text-gray-900">{tApp('name')}</span>
              </div>
              <LanguageSwitcher />
            </div>
          </header>
